      ...
      <Box sx={{ mt: 4, mb: 4 }}>
        ...
        <Paper sx={{ p: 3 }}>
          ...
          <Typography paragraph>
            ...
            sitoutumisvelvoitteita. Sovellus on tarkoitettu ajokoulutuksen seurantaan, mutta
            käyttäjä voi käyttää sitä myös muihin tarkoituksiin.
          </Typography>
          ...
          <Typography paragraph>
            ...
            vahingoista, jotka aiheutuvat sovelluksen käytöstä tai kyvyttömyydestä käyttää
            sovellusta.
          </Typography>
          ...
          <Typography paragraph>
            ...
            toimivuutta kaikissa tilanteissa. Kehittäjä ei vastaa sovelluksen mahdollisista
            virheistä tai toimintahäiriöistä tai niiden aiheuttamista vahingoista.
          </Typography>
          ...
          <Typography paragraph>
            Pidätämme oikeuden muuttaa näitä käyttöehtoja milloin tahansa ilman erillistä
            ilmoitusta. Käyttämällä sovellusta hyväksyt voimassaolevat käyttöehdot.
          </Typography>
