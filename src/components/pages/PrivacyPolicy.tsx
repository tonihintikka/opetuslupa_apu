    ...
    <Container maxWidth="md">
      <Box sx={{ mt: 4, mb: 4 }}>
        ...
        <Paper sx={{ p: 3 }}>
          ...
          <Typography paragraph>
            Kaikki sovelluksessa syötetyt tiedot tallennetaan ainoastaan käyttäjän omalle
            laitteelle, paikalliseen tietokantaan. Mitään tietoja ei lähetetä sovelluksen
            kehittäjille tai kolmansille osapuolille.
          </Typography>
          ...
          <Typography paragraph>
            Käsittelemme tietoja sovelluksen toiminnallisuuden kannalta välttämättömän oikeutetun
            edun perusteella. Koska kaikki tiedot pysyvät laitteellasi, niiden käsittely on täysin
            sinun hallinnassasi.
          </Typography>
          ...
          <Typography paragraph>
            Sovellus ei anna kenellekään kolmannelle osapuolelle pääsyä tietoihisi ilman
          ...
          <Typography paragraph>
            ...
            käyttömääriä ja käyttöaikoja. Näitä tietoja käytetään vain sovelluksen kehittämiseen,
            eikä niitä voida yhdistää yksittäisiin käyttäjiin.
          </Typography>
          ...
          <Typography paragraph>
            Jos sinulla on kysyttävää tietosuojakäytännöistämme, ota yhteyttä sovelluksen
            kehittäjään.
          </Typography>
