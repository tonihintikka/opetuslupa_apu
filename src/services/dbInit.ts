...
export const initializeDatabase = async (): Promise<void> => {
  ...
  try {
    ...
    await lessonService.add({
      ...
      endTime: '15:30',
      topicRatings: [
        { topicId: 'Basic controls', rating: 3 },
        { topicId: 'Starting and stopping', rating: 2 },
      ],
    ...
    await lessonService.add({
      ...
      endTime: '11:30',
      topicRatings: [
        { topicId: 'City driving', rating: 0 },
        { topicId: 'Traffic lights', rating: 0 },
      ],
      notes: '',
      kilometers: 0,
      completed: false,
    ...
    await lessonService.add({
      ...
      endTime: '14:30',
      topicRatings: [
        { topicId: 'Highway driving', rating: 0 },
        { topicId: 'Overtaking', rating: 0 },
      ],
      notes: '',
      kilometers: 0,
      completed: false,
